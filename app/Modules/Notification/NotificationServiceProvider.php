...
final class NotificationServiceProvider extends ModuleServiceProvider
{
    ...
    protected function listeners(): array
    {
        return [
            ...
            'App\Modules\Trading\Events\OtcOfferCreated' => [NotifyOnDomainEvent::class],
            'App\Modules\Trading\Events\RfqAccepted' => [NotifyOnDomainEvent::class],
            ...
            'App\Modules\Custody\Events\AssayAdjusted' => [NotifyOnDomainEvent::class],
