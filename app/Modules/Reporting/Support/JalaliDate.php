 ...
 *
 * Every report a member reads is dated شمسی (§15.10 — «تاریخ شمسی به‌صورت
 * رشته + یک ستون تاریخ میلادی برای مرتب‌سازی»). This is a deliberate
 * duplicate of Accounting\Support\JalaliDate and Dispute\Support\JalaliDate:
 * promoting it to Shared/ is off limits to this agent, and a fixed-algorithm
 * pure function is a cheaper duplication than a dependency between three
 * unrelated modules. Consolidating the three copies under Shared\Support is a
