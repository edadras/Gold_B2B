...
```
ورودی‌ها:
  ounce_usd      قیمت هر اونس تروا به دلار      مثلاً 2,650.40
...
محاسبه:
  ارزش هر گرم طلای خالص (999.9):
      ...
      = 2,650.40 × 620,000 / 31.1034768
      = 52,831,649 ریال (تقریبی)
...
مثال:
  ارزش ذاتی      : 52,831,649 ریال/گرم خالص
...
├──────────────────────────────────────────────────────────────┤
│   ارزش ذاتی: 52,831,649    حباب: +48.54%                      │
